...
def renum_pdbx_poly_seq_scheme_auth_seq_num(mmcif_dict, df_final_dropped_dup, default_mmCIF_num):
    try:
        ...
        _pdbx_poly_seq_scheme_pdb_strand_id = mmcif_dict["_pdbx_poly_seq_scheme.asym_id"]
        ...
        try:
            ...
            _pdbx_poly_seq_scheme_pdb_strand_id = mmcif_dict["_pdbe_orig_poly_seq_scheme.asym_id"]
    ...
    df_mmCIF_pdbx_poly_seq_scheme = pd.DataFrame(zip(mmCIF_pdbx_poly_seq_scheme_pdb,
    ...
    df_pdbx_poly_seq_scheme_auth_final = df_mmCIF_pdbx_poly_seq_scheme.merge(
        df_final_dropped_dup, left_on="pdbx_poly_seq_scheme_pdb", right_on="auth_mmCIF", how='left')
    ...
    df_pdbx_poly_seq_scheme_auth_final["New_Three_Rows_CIF_Num_Uni"] = np.where(
        df_pdbx_poly_seq_scheme_auth_final['new_col'] != "OK",
